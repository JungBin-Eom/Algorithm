...
def doRotate(side, direction):
  global cubeU, cubeD, cubeF, cubeB, cubeL, cubeR
  if side == 'U':
    if direction == '+':
      cubeU = clock(cubeU)
    ...
    if direction == '+':
      ...
      cubeU[2][2], cubeU[1][2], cubeU[0][2] = cubeB[2][2], cubeB[1][2], cubeB[0][2]
  return
